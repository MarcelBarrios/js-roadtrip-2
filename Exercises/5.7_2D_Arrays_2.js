...
const title = eightiesMovies[1][0] +' '+ eightiesMovies[1][1] +' '+ eightiesMovies [1][2] +
            ' ' + eightiesMovies [1][3] + ' '  + eightiesMovies [1][4]

const title2 = `${eightiesMovies[1][0]} ${eightiesMovies[1][1]} ${eightiesMovies[1][2]} ${eightiesMovies[1][3]} ${eightiesMovies[1][4]}`
 console.log(title);
 console.log(title2);
